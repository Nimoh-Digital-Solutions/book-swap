...
LOCATIONS = [
    ...
    (
        ...
        "Carolina MacGillavrylaan, 1098 XH",
        MeetupCategory.STATION,
        "Amsterdam",
        4.9480,
        52.3527,
    ),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Seeded {created_count} new meetup locations ({MeetupLocation.objects.count()} total).")
        )
