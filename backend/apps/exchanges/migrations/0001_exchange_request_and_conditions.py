    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offered_book', models.ForeignKey(help_text="The requester's book offered in exchange.", on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_requests', to='bookswap.book')),
                ...
                ('requested_book', models.ForeignKey(help_text="The owner's book the requester wants.", on_delete=django.db.models.deletion.CASCADE, related_name='incoming_requests', to='bookswap.book')),
