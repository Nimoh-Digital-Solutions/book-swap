...
| [6. Monitoring & Observability](#6-monitoring--observability) | **4 / 5** | Sentry alerts (5/4/4 rules across BE/FE/mobile) + UptimeRobot 3 monitors + Telegram digests every 4h + Expo push receipt reconciliation; APM + structured log shipping still pending |
